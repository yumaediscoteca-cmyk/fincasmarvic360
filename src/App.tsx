...
import EncargadoPostLoginRedirect from "./components/EncargadoPostLoginRedirect";
...
const ParteEncargado = lazy(() => import("./pages/ParteEncargado"));
    ...
    <SidebarProvider>
      <QueryClientProvider client={queryClient}>
        <TooltipProvider>
          ...
          <Sonner />
          <BrowserRouter>
            <EncargadoPostLoginRedirect />
            <Routes>
              <Route
                path="/parte-encargado"
                element={
